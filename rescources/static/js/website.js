...
var timeControlAnimation = (function() {
  ...
  var rulerEl = document.querySelector('.ruler');
  ...
  function pxToTime(px) {
    var width = window.innerWidth > rulerEl.offsetWidth ? rulerEl.offsetWidth + 180 : window.innerWidth;
